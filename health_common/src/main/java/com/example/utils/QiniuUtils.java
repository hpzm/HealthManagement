...
//    public  static String bucket = "itcasthealth_space_1";
    public  static String accessKey = "mp5JPf80egBwdReqzNF6KcmA95SZ_pavbAhKZOF2";
    public  static String secretKey = "saPuXpPxijF1JRWya2xemzwBsbAq9pdUCoahSE55";
    public  static String bucket = "health1277";
